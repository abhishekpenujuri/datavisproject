class AwardStats {
    ...
    createTable(data,seasonNo){
        ...
        let tableHeaders = ["-","Season", "Year", "Orange Cap", "Purple Cap", "Man of the Series", "Most Man of the Matches","Season Winner",
            "Number of Matches", "Host Country", "Most Wins",
        "Most Toss Wins"];
        ...
        let cells = rows.selectAll("td")
            ...
            .data(function (d) {
                ...
                return [ d["-"],
                    ...
                    d["numberOfMatches"], d["hostCountry"], d["mostWins"], d["tossWinMax"]
                ]
            });
    ...
    genBarchart(data,seasonNo){
        ...
        rect.attr("x", function(d, i) {
            ...
            .attr("width", xScale.bandwidth()).on("mouseover", function() { tooltip.style("display", null); })
